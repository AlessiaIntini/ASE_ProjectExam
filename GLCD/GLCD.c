...
void DisegnaPixel(uint16_t X1pos,uint16_t Y1pos,uint16_t X2pos,uint16_t Y2pos,uint16_t color){
	int x,y;
	LCD_DrawLine(X1pos,Y1pos,X2pos,Y1pos,color);
	LCD_DrawLine(X2pos,Y1pos,X2pos,Y2pos,color);
	LCD_DrawLine(X1pos,Y2pos,X2pos,Y2pos,color);
	LCD_DrawLine(X1pos,Y1pos,X1pos,Y2pos,color);
