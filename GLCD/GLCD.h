...
//sono le funzioni che devo utilizzare per scrivere sullo schermp
...
void GUI_Text(uint16_t Xpos, uint16_t Ypos, uint8_t *str,uint16_t Color, uint16_t bkColor);  //questa mi fa colorare tutto
void DisegnaPixel(uint16_t X1pos,uint16_t Y1pos,uint16_t X2pos,uint16_t Y2pos,uint16_t color);
...
void LCD_DrawOvale(uint16_t Xpos,uint16_t Ypos, uint16_t radius, uint16_t color);
void DisegnaRett(uint16_t X1pos,uint16_t Y1pos,uint16_t X2pos,uint16_t Y2pos,uint16_t color);
